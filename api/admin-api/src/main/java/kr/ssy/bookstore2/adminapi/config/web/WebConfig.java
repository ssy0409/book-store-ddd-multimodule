...
import kr.ssy.bookstore2.adminapi.config.resolver.AdminDetailsResover;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
        argumentResolvers.add(new AdminDetailsResover());
        //    argumentResolvers.add(new CustomManagerDetailsResolver());
    }
